...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setInterval(()=>{
        if(con === 0){
            ...
            headText.innerText = "Muestra los dientes y sonrie ampliamente 🤩";
            con += 1;
        }else if(con === 2){
            headText.innerText = "Extiende mas tu sonrisa 😃 ";
            con += 1;
        }else{
            headText.innerText = "Sonríe 😃 por 3 segundos para empezar el juego";
            con = 0;
        }
    }, 4000)
});
