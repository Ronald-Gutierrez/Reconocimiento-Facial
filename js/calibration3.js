...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setInterval(()=>{
        if(con === 0){
            ...
            headText.innerText = "Debes cerrar los ojos 😞 de la tristeza";
            con += 1;
        }else if(con === 2){
            headText.innerText = "No olvides cerrar tus labios 🫦 de la pena";
            con += 1;
        }else{
            headText.innerText = "Entristece 🥹 por 3 segundos para empezar el juego";
            con = 0;
        }
    }, 4000)
});
