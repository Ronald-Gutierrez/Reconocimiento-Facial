...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setInterval(()=>{
        if(con === 0){
            ...
            headText.innerText = "Debes abrir tu boca 😮 de la sorpresa";
            con += 1;
        }else if(con === 2){
            headText.innerText = "No olvides abrir bien los ojos 👁️👁️";
            con += 1;
        }else{
            headText.innerText = "Sosprendete 😮 por 3 segundos para empezar el juego ";
            con = 0;
        }
    }, 4000)
});
